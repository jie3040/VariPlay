...
class MyAdvantageEstimator(str, Enum):
    """Extra advantage estimators registered on top of vanilla verl."""
    TDGRPO = "tdgrpo"
    GAPO = "gapo"
    ADPO = "adpo"
...
def compute_adpo_outcome_advantage(
    ...
    # The generated data carries a self-consistency score. ADPO trusts high-score
    # samples more and scales low-confidence advantages down.
    ...
    with torch.no_grad():
        ...
        # At min_score the multiplier is min_advantage_scale; at max_score it is 1.
...
def compute_policy_loss_adpo(
    ...
    # Lower-score samples are treated as more exploratory, so they receive a
    # larger upper clipping range than high-confidence samples.
